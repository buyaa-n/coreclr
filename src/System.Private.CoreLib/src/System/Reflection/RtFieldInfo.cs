    ...
    internal unsafe sealed class RtFieldInfo : RuntimeFieldInfo, IRuntimeFieldInfo
    {
        ...
        public override object GetValueDirect(TypedReference obj)
        {
            ...
            unsafe
            {
                ...
                return RuntimeFieldHandle.GetValueDirect(this, (RuntimeType)FieldType, &obj, DeclaringType as RuntimeType);
            }
        }
        ...
        public override void SetValueDirect(TypedReference obj, object value)
        {
            ...
            {
                // Passing TypedReference by reference is easier to make correct in native code
                RuntimeFieldHandle.SetValueDirect(this, (RuntimeType)FieldType, &obj, value, DeclaringType as RuntimeType);
            }
        }
