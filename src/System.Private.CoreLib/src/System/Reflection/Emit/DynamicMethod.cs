...
namespace System.Reflection.Emit
{
    ...
    {
        private RuntimeType[] m_parameterTypes = null!;  // set in Init()
        ...
        private RuntimeModule m_module = null!; // set in Init()
        ...
        private RTDynamicMethod m_dynMethod = null!; //set in Init()
        ...
        public override object Invoke(object? obj, BindingFlags invokeAttr, Binder? binder, object?[]? parameters, CultureInfo? culture)
        {
            ...
            object retValue;
            if (actualCount > 0)
            { // Doc says binder can be null and default Binder would set in that case, but i don't see default binder set and in  
              // this method https://github.com/dotnet/coreclr/blob/master/src/System.Private.CoreLib/src/System/RtType.cs#L3779
              // where it will throw ArgumentException if binder is null or Default binder is used, it might be a bug or ...
